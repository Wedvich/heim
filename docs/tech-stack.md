...
| E2E testing        | Playwright (planned)                               | Against dedicated test tenant                                                    |
| Linting            | oxlint                                             |                                                                                  |
...
| Releases           | @changesets/cli (planned)                          | Monorepo-aware changelogs + GitHub Releases                                      |
...
| Auth               | Session-based (opaque tokens), Google OIDC         | Custom implementation, extensible provider registry                              |
