...
- **Domain logic currently lives in `@heim/api`** — to be extracted to `@heim/domain` as the domain model matures; api and web are intended as infrastructure/UI shells
